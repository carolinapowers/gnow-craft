...
export function renderComponent(
  ...
  const { shallow, ...mountOptions } = options
  ...
  const finalOptions: MountingOptions<any> = {
    ...mountOptions,
    global: {
      ...mountOptions.global,
...
export async function testComputed(
  ...
  await setupState()
  await wrapper.vm.$nextTick()
  expect(wrapper.vm[computedName]).toEqual(expectedValue)
}
